...
$resultado=$producto->baja($idcategoria_producto);

if ($resultado) {
	echo "<meta http-equiv='REFRESH' content='0; url=../ver_registro_cat.php'><script>alert('La categoria se dio de baja exitosamente') </script>";
}else{
