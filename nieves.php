...
<br><br>
  <div>
 <div class="card-group" style="width:250px; height: 200px;">
  <div class="card" style="width: ; background-color: #D1E9FD;">
    <img src="img/p1.jpeg" class="card-img-top" style="width:248px; height:200px; " alt="...">
    <div class="card-body">
      <h5 class="card-title">Paleta de mango</h5>
      ...
      <a href="agua.html"> <button type="button" class="btn btn-outline-secondary" style="background-color:#F3FC64 ;">Comprar</button></a>
    </div>
  </div>
</div>
...
<div class="card-group" style="width:250px; height: 200px;">
  <div class="card" style="width: ; background-color: #D1E9FD;">
    <img src="img/p1.jpeg" class="card-img-top" style="width:248px; height:200px; " alt="...">
    <div class="card-body">
      <h5 class="card-title">Paleta de limon</h5>
      <p class="card-text">Es esto esto y esto bla blabbalbalbalablabla</p>
      <p class="card-text"><small class="text-muted">Precio "Ponganlo"</small></p>
      <a href="Paletas.html"> <button type="button" class="btn btn-outline-secondary" style="background-color:#F3FC64 ;">Comprar</button></a>
    </div>
  </div>
</div>
...
<div class="card-group" style="width:250px; height: 200px;">
  <div class="card" style="width: ; background-color: #D1E9FD;">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Es esto esto y esto bla blabbalbalbalablabla</p>
      <p class="card-text"><small class="text-muted">Precio "Ponganlo"</small></p>
      <a href="nieves.html"> <button type="button" class="btn btn-outline-secondary" style="background-color:#F3FC64 ;">Comprar</button></a>
    </div>
  </div>
</div>
 ...
 <div class="card-group" style="width:250px; height: 200px;">
  <div class="card" style="width: ; background-color: #D1E9FD;">
    <img src="img/p1.jpeg" class="card-img-top" style="width:248px; height:200px; " alt="...">
    <div class="card-body">
      <h5 class="card-title">Paleta de yogurt</h5>
      <p class="card-text">Es esto esto y esto bla blabbalbalbalablabla</p>
      <p class="card-text"><small class="text-muted">Precio "Ponganlo"</small></p>
      <a href="agua.html"> <button type="button" class="btn btn-outline-secondary" style="background-color:#F3FC64 ;">Comprar</button></a>
    </div>
...
<div class="card-group" style="width:250px; height: 200px;">
  <div class="card" style="width: ; background-color: #D1E9FD;">
    <img src="img/p1.jpeg" class="card-img-top" style="width:248px; height:200px; " alt="...">
    <div class="card-body">
      <h5 class="card-title">Agua de chamoy</h5>
      <p class="card-text">Es esto esto y esto bla blabbalbalbalablabla</p>
      <p class="card-text"><small class="text-muted">Precio "Ponganlo"</small></p>
      <a href="Paletas.html"> <button type="button" class="btn btn-outline-secondary" style="background-color:#F3FC64 ;">Comprar</button></a>
    </div>
...
<div class="card-group" style="width:250px; height: 200px;">
  <div class="card" style="width: ; background-color: #D1E9FD;">
    <img src="img/p1.jpeg" class="card-img-top" style="width:248px; height:200px; " alt="...">
    <div class="card-body">
      <h5 class="card-title">Agua de mora azul</h5>
      <p class="card-text">Es esto esto y esto bla blabbalbalbalablabla</p>
      <p class="card-text"><small class="text-muted">Precio "Ponganlo"</small></p>
      <a href="Paletas.html"> <button type="button" class="btn btn-outline-secondary" style="background-color:#F3FC64 ;">Comprar</button></a>
    </div>
        ...
        <div class="pull-right">
          ...
          <div class="redes-footer">
            <a href="https://www.facebook.com/rubeneduardo.perazaesquer"/><img src=img/fb.png style="width:50px; height:50px;"></a>
              <a href="https://www.instagram.com/rubeneduardo.perazaesquer"/><img src=img/ig.png style="width:50px; height:50px;"></a>
