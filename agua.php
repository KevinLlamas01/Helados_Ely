...
<body style="background-color: #A3E4D7;">
 ...
 <div class="card-group" style="width:250px; height: 200px;">
  <div class="card" style="width: ; background-color: #D1E9FD;">
    ...
    <div class="card-body">
      <h5 class="card-title">Agua de no se q</h5>
      ...
      <a href="compra.html"> <button type="button" class="btn btn-outline-secondary" style="background-color:#F3FC64 ;">Comprar</button></a>
    </div>
  </div>
</div>
...
<div class="card-group" style="width:250px; height: 200px;">
  <div class="card" style="width: ; background-color: #D1E9FD;">
    <img src="img/p1.jpeg" class="card-img-top" style="width:248px; height:200px; " alt="...">
    <div class="card-body">
      <h5 class="card-title">Agua de horchata</h5>
      <p class="card-text">Es esto esto y esto bla blabbalbalbalablabla</p>
      <p class="card-text"><small class="text-muted">Precio "Ponganlo"</small></p>
      <a href="compra.html"> <button type="button" class="btn btn-outline-secondary" style="background-color:#F3FC64 ;">Comprar</button></a>
    </div>
...
<div class="card-group" style="width:250px; height: 200px;">
 ...
 <div class="card-group" style="width:250px; height: 200px;">
  <div class="card" style="width: ; background-color: #D1E9FD;">
    <img src="img/p1.jpeg" class="card-img-top" style="width:248px; height:200px; " alt="...">
    <div class="card-body">
      <h5 class="card-title">Agua calzon</h5>
      <p class="card-text">Es esto esto y esto bla blabbalbalbalablabla</p>
      <p class="card-text"><small class="text-muted">Precio "Ponganlo"</small></p>
      <a href="compra.html"> <button type="button" class="btn btn-outline-secondary" style="background-color:#F3FC64 ;">Comprar</button></a>
    </div>
...
<div class="card-group" style="width:250px; height: 200px;">
  <div class="card" style="width: ; background-color: #D1E9FD;">
    <img src="img/p1.jpeg" class="card-img-top" style="width:248px; height:200px; " alt="...">
    <div class="card-body">
      <h5 class="card-title">Agua de limon</h5>
      <p class="card-text">Es esto esto y esto bla blabbalbalbalablabla</p>
      <p class="card-text"><small class="text-muted">Precio "Ponganlo"</small></p>
      <a href="compra.html"> <button type="button" class="btn btn-outline-secondary" style="background-color:#F3FC64 ;">Comprar</button></a>
    </div>
...
<div class="card-group" style="width:250px; height: 200px;">
  <div class="card" style="width: ; background-color: #D1E9FD;">
    <img src="img/p1.jpeg" class="card-img-top" style="width:248px; height:200px; " alt="...">
    <div class="card-body">
      <h5 class="card-title">Agua de naranja</h5>
      <p class="card-text">Es esto esto y esto bla blabbalbalbalablabla</p>
      <p class="card-text"><small class="text-muted">Precio "Ponganlo"</small></p>
      <a href="comp.html"> <button type="button" class="btn btn-outline-secondary" style="background-color:#F3FC64 ;">Comprar</button></a>
    </div>
  </div>
</div>
